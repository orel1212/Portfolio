...
_SIGNATUREDEFMAP_SIGNATUREDEFENTRY.fields_by_name[
    'value'].message_type = tensorflow_dot_core_dot_protobuf_dot_meta__graph__pb2._SIGNATUREDEF
...
_GETMODELMETADATAREQUEST.fields_by_name[
    'model_spec'].message_type = tensorflow__serving_dot_apis_dot_model__pb2._MODELSPEC
...
GetModelMetadataResponse = _reflection.GeneratedProtocolMessageType('GetModelMetadataResponse', (_message.Message,),
                                                                    dict(
                                                                        ...
                                                                        MetadataEntry=_reflection.GeneratedProtocolMessageType(
                                                                            'MetadataEntry', (_message.Message,), dict(
...
_GETMODELMETADATARESPONSE_METADATAENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(),
                                                                             _b('8\001'))
